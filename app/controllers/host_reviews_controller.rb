class HostReviewsController < ApplicationController
  ...
  def create
    ...
    if !@reservation.nil?
      ...
      if @has_reviewed.nil?
          ...
          flash[:success] = "เพิ่มรีวิวของคุณแล้ว..."
      else
          # Already reviewed
          flash[:success] = "คุณได้เพิ่มรีวิวสำหรับที่นี่แล้วนะ"
      end
    else
      flash[:alert] = "ไม่พบการจอง"
    end
  ...
  def destroy
    ...
    redirect_back(fallback_location: request.referer, notice: "รีวิวถูกลบแล้วค่ะ...!")
  end
