Rails.application.configure do
  ...
  config.action_cable.url = "ws://intense-hamlet-49488.herokuapp.com:3000/cable"

  config.action_mailer.default_url_options = { host: 'intense-hamlet-49488.herokuapp.com', port: 3000 }
